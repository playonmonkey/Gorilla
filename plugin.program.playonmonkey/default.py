...
def viewBuild(name):
	...
	for version, url, url2, url3, gui, kodi, themefile, icon, fanart, adult, description, preview in match:
		...
		addFile('Update Installation'   , 'install', name, 'fresh'  , description=description, fanart=fanart, icon=icon, themeit=THEME1)
		addFile('1st Time Installation', 'install', name, 'normal' , description=description, fanart=fanart, icon=icon, themeit=THEME1)
...
def apkMenu(name=None, url=None):
	...
	if HIDESPACERS == 'No': addFile(wiz.sep('install Apks'), '', themeit=THEME3)
