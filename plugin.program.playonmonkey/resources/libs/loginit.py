...
ORDER          = ['gfvip2', 'iptvsubs', 'sportsaccess', 'smoothstreams', 'communityportal', 'tvportal', 'flawless', 'opensubtitles', 'sportsmania', 'sportsnationhdtv', 'ultimatemania', 'otttv', 'ivue', 'ontapptv', 'vpnicity', 'overlordtv', 'xtreamcodes']
